...
                      className="absolute top-2 right-2 p-2 bg-green-600 text-gray-600 rounded-lg hover:bg-green-500 hover:text-gray-800 transition-all shadow-sm border border-gray-200"
